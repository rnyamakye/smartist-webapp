...
const Gallery = () => {
  ...
  const artworks = [
    ...
    {
      src: "/commmissioned-portrait-31.JPG",
      // description:
      //   "A mural painting depicting the last meal of Jesus with his apostles.",
    },
    {
      src: "/commmissioned-portrait-32.JPG",
      // description:
      //   "A Romantic landscape painting of a man standing on a rocky precipice.",
    },
    {
      src: "/commmissioned-portrait-33.JPG",
      // description:
      //   "A mural painting depicting the last meal of Jesus with his apostles.",
    },
    {
      src: "/commmissioned-portrait-34.JPG",
      // description:
      //   "A Romantic landscape painting of a man standing on a rocky precipice.",
    },
    {
      src: "/commmissioned-portrait-35.JPG",
      // description:
      //   "A mural painting depicting the last meal of Jesus with his apostles.",
    },
    {
      src: "/commmissioned-portrait-36.JPG",
      // description:
      //   "A Romantic landscape painting of a man standing on a rocky precipice.",
    },
    {
      src: "/commmissioned-portrait-37.JPG",
      // description:
      //   "A mural painting depicting the last meal of Jesus with his apostles.",
    },
    {
      src: "/commmissioned-portrait-4.JPG",
      // description:
      //   "A Romantic landscape painting of a man standing on a rocky precipice.",
    },
    {
    ...
    {
      src: "/commmissioned-portrait-6.JPG",
      // description:
      //   "A Romantic landscape painting of a man standing on a rocky precipice.",
    },
    {
    ...
    {
      src: "/commmissioned-portrait-8.JPG",
      // description:
      //   "A Romantic landscape painting of a man standing on a rocky precipice.",
    },
    {
      src: "/commmissioned-portrait-9.JPG",
      // description:
      //   "A mural painting depicting the last meal of Jesus with his apostles.",
    },
  ];
